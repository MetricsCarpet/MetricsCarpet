...
* If the MCR is not installed, run MCRInstaller, located in:
  ...
  /broad/tools/apps/matlab2009b2/toolbox/compiler/deploy/glnxa64/MCRInstaller.bin
...
================================
-CPCluster.ctf (component technology file)
-CPCluster 
-run_CPCluster.sh (shell script run to
...
CPCluster uses for successful execution of exported M functions. 
     ...
     ii. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_CPCluster.sh 
